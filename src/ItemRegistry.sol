...
/*
    ...
    NOTE:
    Theoretically there exists the possibilty for collisions in itemHashes generated by
    different users. Because of this, we need some concept of identitifying
    an itemHash in conjunction with the user who created it? For example,
    right now when adding an itemHash to a channel, you cant specifify which
    itemHash it was created from
*/
